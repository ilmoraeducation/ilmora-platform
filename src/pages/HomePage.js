...
import MorphingParticles from '../components/shared/MorphingParticles';
import ChatBot from '../components/shared/ChatBot';
import './HomePage.css';

const UNIVERSITIES = [
  { name:'Om Sterling Global University',  country:'Rajasthan · NAAC', img:'/images/universities/osgu.png',      url:'https://osgu.ac.in' },
  { name:'Jamia Urdu Aligarh',             country:'Aligarh · UGC',    img:'/images/universities/jamia-urdu.png', url:'https://www.jamiaurdu.ac.in' },
  { name:"Lingaya's Vidyapeeth",           country:'Deemed · NAAC',    img:'/images/universities/lingayas.png',   url:'https://lingayasuniversity.edu.in' },
  { name:'Arni University',                country:'HP · UGC Approved',img:'/images/universities/arni.png',       url:'https://www.arniuniversity.edu.in' },
  { name:'Rabindranath Tagore University', country:'MP · NAAC',        img:'/images/universities/rntu.png',       url:'https://www.rntu.ac.in' },
  { name:'Rajiv Gandhi University',        country:'Arunachal · Central',img:'/images/universities/rgu.png',      url:'https://www.rgu.ac.in' },
];

const PROGRAMS = [
  { icon:'🎓', title:'UG Programs',      sub:'Bachelor Degrees',       desc:'BA, BCom, BSc, BCA, BBA. Weekend & online classes for working professionals.' },
  { icon:'🏛️', title:'PG Programs',      sub:'Master Degrees',         desc:'MA, MCom, MSc, MCA, MBA with flexible scheduling. 1–2 year completion.' },
  { icon:'⚙️', title:'BTech / MTech',    sub:'Engineering Degrees',    desc:'Full UAE equivalency support included. Recognized for engineering roles.' },
  { icon:'🔬', title:'PhD Programs',     sub:'Doctoral Research',      desc:'Research-based PhD from accredited universities with full mentorship.' },
  { icon:'📜', title:'Certifications',   sub:'Short Courses',          desc:'Professional certifications in months. Instantly boost your credentials.' },
  { icon:'🌐', title:'UAE Equivalency',  sub:'Recognition Service',    desc:'100% handled by ILMORA. We manage HEC/MOHE submissions and all paperwork.' },
];

const SERVICES = [
  { icon:'📋', title:'Certificate Attestation', desc:'Complete state-level, MEA, and UAE embassy attestation — handled entirely by ILMORA.' },
  { icon:'🇦🇪', title:'UAE Equivalency',        desc:'Full MOHE equivalency process for BTech/MTech. Every submission and follow-up managed.' },
  { icon:'🤝', title:'Personal Advisor',        desc:'Dedicated advisor from enrollment to certificate recognition — you are never alone.' },
...
const FAQS = [
  { q:'Are the certificates internationally recognized?',       a:'Yes. All certificates are from UGC-recognized, NAAC-accredited institutions — accepted internationally including for UAE equivalency and overseas employment.' },
  { q:'Do I need to handle attestation myself?',               a:"Absolutely not. This is ILMORA's biggest differentiator. We handle 100% of the attestation, equivalency, and documentation process on your behalf." },
  { q:'Can I study while working full time?',                  a:"Yes — that's exactly who we built this for. All programs have weekend classes and flexible online learning options. You never need to take leave." },
  { q:'How affordable are the programs?',                      a:'ILMORA programs are significantly more affordable than traditional universities. We offer flexible monthly payment plans with no hidden costs.' },
  { q:'What is UAE equivalency and do you support it?',        a:'UAE equivalency is getting your Indian degree recognized by UAE authorities. ILMORA specializes in this — we handle the entire process for BTech and MTech graduates.' },
  { q:'How long does it take to complete a degree?',           a:'UG degrees typically take 3 years, PG 1–2 years, certifications a few months. ILMORA designs intensive programs to minimize duration without compromising quality.' },
  { q:'What happens after I enroll?',                          a:'You get a dedicated advisor who guides you through classes, assignments, and exams. After graduation, ILMORA handles all your post-degree documentation.' },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const move = (e) => {
      ...
      rx += (e.clientX - 18 - rx) * 0.16;
      ry += (e.clientY - 18 - ry) * 0.16;
  ...
  return (
    <div className="home-page">
      {/* Global morphing particles — fixed layer behind everything */}
      <MorphingParticles />
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub reveal reveal-delay-2">
            Flexible UG, PG &amp; PhD programs for working professionals — with complete attestation,
            equivalency, and documentation support handled by us, A to Z.
          </p>
          ...
          <div className="hero-portal-links reveal">
            ...
            <Link to="/login?role=admin" className="portal-link admin-link">Admin Access →</Link>
          </div>
        </div>
          ...
          <div className="about-grid">
            <div className="reveal">
              ...
              <p className="section-body" style={{marginBottom:'1.5rem'}}>
                ILMORA is not just a course platform — it is your complete A-to-Z career development partner.
                We make quality, accredited education accessible to working professionals worldwide, with{' '}
                <strong style={{color:'#fff'}}>zero administrative burden</strong> on our students.
              </p>
              <p className="section-body">
                From enrollment to the day your certificate is internationally recognized, we handle every step.
                Attestation, equivalency, university documentation — you focus on learning, we handle the rest.
              </p>
            ...
            <div className="about-cards reveal reveal-delay-2">
              {[
                ...
                <div className="glass-card" key={c.title}>
                  <div className="card-icon-lg">{c.icon}</div>
        ...
        <div className="container">
          ...
          <div className="steps-grid">
            {[
              ...
              { n:'2', title:'Enroll & Start Learning', desc:'Weekend classes, online support, assignment help — study at your pace' },
      ...
      <section className="uni-section section-pad" id="universities">
        <div className="container">
          <div className="reveal" style={{textAlign:'center',marginBottom:'4rem'}}>
            ...
            <div className="gold-divider" style={{margin:'1.5rem auto'}}></div>
            <p className="section-body" style={{maxWidth:'540px',margin:'0 auto'}}>
              UGC-recognized, NAAC-accredited institutions whose degrees are accepted internationally — including UAE equivalency.
            </p>
          </div>
          <div className="uni-grid">
            {UNIVERSITIES.map((u, i) => (
              <a href={u.url} target="_blank" rel="noopener noreferrer"
                className={`uni-card reveal reveal-delay-${i%3+1}`} key={u.name}>
      ...
      <section className="contact-section section-pad" id="contact">
        <div className="container">
          <div className="reveal" style={{textAlign:'center',marginBottom:'4rem'}}>
            ...
            <div className="gold-divider" style={{margin:'1.5rem auto'}}></div>
            <p className="section-body" style={{maxWidth:'500px',margin:'0 auto'}}>
              Talk to our advisors — free consultation, no commitment.
            </p>
          </div>
          <div className="contact-grid">
              ...
              {formSuccess ? (
                ...
                <form onSubmit={handleFormSubmit}>
                  ...
                  <div className="form-group">
                    ...
                    <input className="form-input" type="tel" placeholder="+971 or +91 number"
                  ...
                  <div className="form-group">
                    ...
                    <select className="form-input" value={formData.interest}
                  ...
                  <button className="btn-gold" type="submit"
                    style={{width:'100%',justifyContent:'center',padding:'1rem'}} disabled={formSubmitting}>
            ...
            <div className="contact-info-col reveal reveal-delay-2">
              ...
              <a href="https://wa.me/971529682123?text=Hi%20ILMORA%2C%20I%27m%20interested%20in%20your%20programs."
        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p className="footer-brand-desc">Your complete A-to-Z career development partner. Flexible degrees, affordable fees, and full documentation support.</p>
            ...
            <div>
              ...
              <ul className="footer-links">
                ...
                <li><a href="https://wa.me/971529682123" target="_blank" rel="noopener noreferrer">WhatsApp Us</a></li>
              </ul>
  ...
  return (
    <nav className={`navbar ${scrolled?'scrolled':''}`} id="navbar">
      ...
      <ul className={`nav-links ${mobileOpen?'mobile-open':''}`}>
        ...
        <li className="nav-dropdown-wrap" onClick={e => { e.stopPropagation(); setToolsOpen(!toolsOpen); }}>
          <span className="nav-dropdown-trigger">Tools ▾</span>
          {toolsOpen && (
            <div className="nav-dropdown">
              <Link to="/brochure" className="nav-dropdown-item" onClick={() => { setMobileOpen(false); setToolsOpen(false); }}>📄 Brochure Generator</Link>
              <Link to="/poster"   className="nav-dropdown-item" onClick={() => { setMobileOpen(false); setToolsOpen(false); }}>🎨 Poster Generator</Link>
            </div>
          )}
        </li>
        <li className="mobile-only-link"><Link to="/login"           onClick={() => setMobileOpen(false)}>🎓 Student Login</Link></li>
        <li className="mobile-only-link"><Link to="/login?role=admin" onClick={() => setMobileOpen(false)}>🔐 Admin Login</Link></li>
        <li className="mobile-only-link"><Link to="/brochure"        onClick={() => setMobileOpen(false)}>📄 Brochure</Link></li>
        <li className="mobile-only-link"><Link to="/poster"          onClick={() => setMobileOpen(false)}>🎨 Poster</Link></li>
      </ul>
      <div className="nav-right">
        <Link to="/login"            className="nav-student-btn">🎓 Student</Link>
        <Link to="/login?role=admin"  className="nav-admin-btn">🔐 Admin</Link>
        <a href="#contact" className="nav-cta">Free Callback</a>
      </div>
