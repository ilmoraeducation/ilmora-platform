  ...
  return (
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`} id="navbar">
      ...
      <ul className={`nav-links ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <li className="nav-dropdown-wrap" onClick={e => { e.stopPropagation(); setToolsOpen(!toolsOpen); }}>
          ...
          {toolsOpen && (
            <div className="nav-dropdown">
              <Link to="/brochure" className="nav-dropdown-item" onClick={() => { setMobileOpen(false); setToolsOpen(false); }}>
                📄 Brochure Generator
              </Link>
              <Link to="/poster" className="nav-dropdown-item" onClick={() => { setMobileOpen(false); setToolsOpen(false); }}>
                🎨 Poster Generator
              </Link>
            </div>
          )}
        ...
        <li className="mobile-only-link"><Link to="/login" onClick={() => setMobileOpen(false)}>🔐 Admin Login</Link></li>
      </ul>

      <div className="nav-right">
        <Link to="/login" className="nav-student-btn">🎓 Student</Link>
        <Link to="/login" className="nav-admin-btn">🔐 Admin</Link>
